...
<section className="text-gray-600 body-font">
  ...
  <h2 className='text-2xl font-medium tracking-widest text-center title-font py-10'>Popular Products</h2> 
    <div className="mx-auto text-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-center items-center gap-6 -m-4 w-full">
    {
    popularItem.map((item)=>{
      
      return (
      <div className="mx-auto w-full border-[2px] border-gray-300 rounded-md min-h-[200px] h-[330px] overflow-hidden">
